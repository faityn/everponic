        ...
        <div className=" max-w-[1800px] mx-auto w-full pt-24 pb-24">
          <div className="mt-20 max-md:mt-14 flex flex-col ">
            <div className="w-full ">
              <div className="text-[70px] leading-[80px] max-md:text-[30px] max-md:leading-[40px] max-md:text-center fontVarelmo uppercase text-black  pb-8 pl-4">
                Careers
              </div>
              <div className="max-w-[340px] text-xl max-md:text-md text-[#353644] max-md:text-center max-md:mx-auto ">
                Feel free to apply anytime, and we will get back to you after
