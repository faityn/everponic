  ...
  return (
    <>
        ...
        <div className="ml-4 flex items-center md:ml-6">
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-12 max-xl:space-x-6">
              <Link
                href="/"
                className=" px-3 py-2 text-md font-medium text-black border-b-2 border-transparent hover:border-b-2 hover:border-primary hover:text-primary"
                aria-current="page"
              >
                Home
              </Link>

              <div className="dropdown inline-block relative px-3 py-2 text-md border-b-2 border-transparent font-medium text-black hover:border-b-2 hover:border-primary hover:text-primary">
              ...
              <div className="dropdown inline-block relative px-3 py-2 text-md font-medium text-black  hover:border-b-2 border-primary hover:text-primary">
      ...
      <div className="-mr-2 flex gap-7 items-center md:hidden">
        ...
        <button
          type="button"
          className="relative inline-flex items-center justify-center rounded-md text-black hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2  focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
...
export default HeaderMenuBlackD;
