...
const Page = () => {
    const BannerInfo = {
        title: "Distribution",
        text: "about sales channels by purchasing products from partners. It also allows consumers to receive the products they want, in the quantities they need, at reasonable prices, regardless of the season, through planned production and cultivation.",
