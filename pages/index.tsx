                ...
                <div className="bg-[#111111] pt-[130px] pb-[130px] max-sm:pt-[50px] max-sm:pb-[30px] relative ">
                    ...
                    <div className="flex flex-col items-center justify-center w-full text-[30px] max-sm:text-xl relative">
                        <div>
                            ...
                            >
                                We provides modular container plant factory
                                capable of{" "}
                            </div>
                            <div
                                className={`${
                            ...
                            >
                                producing sustainable fresh crops. Our system is
                                designed for easy{" "}
                            </div>
                            <div
                                className={`${
                            ...
                            >
                                operation by users. Furthermore, we enables
                            ...
                            >
                                they desire through planned production and
                                cultivation.
                            </div>
                        </div>
                    </div>
