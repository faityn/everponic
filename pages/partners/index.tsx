            ...
            >
                <div className=" max-w-[1800px] mx-auto w-full pt-24 pb-24">
                    ...
                    <div className="max-w-[939px] mx-auto text-center fontPretendard  text-3xl text-[#767676]">
                        Partners are future-oriented collaborators who provide
                        business idea, manpower, finance, products and services
                        that complement our solutions and capabilities. Please
                        join us in expanding modular vertical plant factory
                        globally through close collaboration with us.
                    </div>
