        ...
        <div id="section2" className="bg-white text-black whitespace-pre-line">
          <div className=" max-w-[1800px] mx-auto w-full pt-24 pb-24">
            ...
            <div className="max-w-[1080px] mx-auto text-center fontPretendard  text-3xl text-[#767676]">
              ...
              capable of producing sustainable fresh crops. Our system is
              designed for easy operation by users. Furthermore, EVERPONIC
              enables consumers and businesses to directly receive the
              <span className="text-black font-medium">
                {" "}
